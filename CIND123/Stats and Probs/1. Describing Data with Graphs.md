...
- A time series is when a quantitative variable is recoded over time at equally spaced intervals
- Time series data are most effectively presented on a line chart with time as the horizontal axis, to discern a pattern or trend

![](Pasted%20image%2020250512163826.png)


## Dotplots

 - A simple statistical chart used to display the frequency of data points in a small dataset

![](Pasted%20image%2020250512163941.png)

## Stem and Leaf Plots

- A graphical display of the data using the actual numerical values of each data point

![](Pasted%20image%2020250512164134.png)

![](Pasted%20image%2020250512164153.png)

- Stems are divided in one of two way
1) Into two lines, with leaves 0-4, and 5-9
2) Into five lines, with leaves 0-1, 2-3, 4-5, 6-7, and 8-9

![](Pasted%20image%2020250512164304.png)

![](Pasted%20image%2020250512164701.png)

- The stems are divided into two lines


## Interpreting Graphs with a Critical Eye

- Checks the horizontal and vertical scales
- Examine the location of the data distribution
- Example the shape of the distribution
- Look for outliers


**Symmetric distribution** - if the left and right sides of the distributions, when divided at the middle value, form mirror images

![](Pasted%20image%2020250512165025.png)

**Skewed to the right** - if a greater proportion of the measurements lie to the right of the peak value

![](Pasted%20image%2020250512165105.png)

**Skewed to the left** - if a greater proportion of the measurements lie to the left of the peak value

**Unimodal** - if a distribution has one peak
**Bimodal** - if a distribution has two peak
...
- A relative frequency histogram resembles a bar chart, but it is used to graph quantitative rather than qualitative

![](Pasted%20image%2020250512165413.png)

**Relative frequency histogram** - A quantitative data set is a bar graph in which the height of the bar shows how often measurements fall in a particular class of subinterval

highest = 9.4
Lowest - 5.6
Range = 3.8
Intervales = range x 2 = ~8

$3.8 / 8 = .475 = ~0.5$

**Method of left inclusion** - subintervals that include the left class boundary point, but not the right boundary point in the class

![](Pasted%20image%2020250512165846.png)

![](Pasted%20image%2020250512165829.png)

- The percentage of total area under the histogram is also the proportion of the relative classes
