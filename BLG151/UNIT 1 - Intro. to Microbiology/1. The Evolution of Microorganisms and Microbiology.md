...
- Only values greater than 95% are acceptable

- Bootstrapping involved re-analyzing a randomly selected subset of the data presented on the tree
- A bootstrap value is the percent of times in which that particular branch was found
- Typically, bootstrap values of 70% or greater are though to support a tree

- Phylogenetic trees represent evolutionary history of a molecule
- The distance between nodes is a measure of relatedness, not of time
- An unrooted tree represents phylogenetic relationship, but does not indicate which organisms are more primitive relative to the other
- The rooted tree includes a node (taxonomic unit) that serves as the common ancestor and shows the development of the four species from this rppt

![](Pasted%20image%2020250517145348.png)

- An unrooted tree can be rooted by adding data from an out-group (a species known to be very distantly related to all the species in the tree)
- The root is determined by the point of the tree where the out-group joins

## Microbial Taxonomy

**Taxonomy** - The science of biological classification; it consists of 3 parts
1. Classification
2. Nomenclature
3. Identification

- Microbes are places in taxonomic levels arranged in a non-overlapping hierarchy so that each level includes not only the traits that define the rank above it, but also a new set of more restrictive traits

![](Pasted%20image%2020250517145800.png)

- ==Carl Linnaeus== is the microbiologists that defines the binomial system

**Species** - Species of higher organisms are groups of interbreeding or potentially interbreeding natural populations that are reproductively isolated
- Archaeal and bacterial species are often defined as collections of strains that have many stable properties in common and differ significantly from other strains
- There is currently considerable debate about the best definition of archaea and bacterial species

- Comparisons of genome sequences are used to distinguish bacterial and archaeal species

**Strain** - A population of organisms that descends from a single organisms or pure culture isolate

- _Biovars_ - variant strains characterized by biochemical or physiological differences
- _Morphovars_ - differ morphologically
- _Serovars_ - distinct properties that can be detected by antibodies
- _Pathovars_ - pathogenic strains distinguished by the plants in which they cause disease

- Within the last few decades, thousands of 16S rRNA genes and protein-coding genes have been sequences that do not belong to any previously defined taxa
- This has led to a new taxonomic classification of super-phylum (below domain, above phylum)

**Super-phylum** - A classification of organisms below the level of domain but above phylum; includes several phyla that are united by one or more distinct characteristic
...
**Microbiology** - The study of organisms that are usually too small to be seen with the naked eye

**Pure/axenic culture** - a population of cells that are identical because they arise from a single cell

- Roman philosopher Lucretius (98 - 44 BCE) and the physician Girolamo Fracastoro (1478 - 1533) suggested that disease was caused by invisible living creatures

![](Pasted%20image%2020250523171525.png)


## Microscopy Led to the Discovery of Microorganisms

Francesco Stelluti (1577 - 1652)
- Earliest microscope observation of organisms
- Microscope from Galileo

Robert Hooke (1635 - 1703)
- Published the first drawings of microorganisms
- Fungus _Mucor_ in Micrographia

Antony van Leeuwenhoek (1632 - 1723)
- Created microscopes that could magnify 50 to 300 times
- Drawings of bacteria from the human mouth

## Culture-based Methods for Studying Microorganisms Were a Major Development

### Spontaneous Generation

**Spontaneous generation** - an early belief that living organisms could develop from non-living matter

Francesco Redi (1626 - 1697)
- First one to challenge spontaneous generation
- Decaying meat produced maggots

John Needham (1713 - 1781)
- Suggested spontaneous generation occurs
- Microorganisms grew on boiled hay or meat

Lazzaro Spallanzani (1729 - 1799)
- No growth took place when he boiled seeds in water
- Air carried germs to the culture medium
- Did not disprove spontaneous generation, since heat could cause death

Felix Pouchet (1800 - 1872)
- Microbial growth could occur without contact with air

Louis Pasteur (1822 - 1895)
- Disproved spontaneous generation through Swan-Neck Flasks
- Proved microoorganisms existed
...
- Heat-resistant bacteria were producing bacteria endospores
- Classification system for bacteria based on morphology and physiology

### Microorganisms and Disease

Galen (129 - 199)
- Greek physician
- Support four humors (blood, phlegm, yellow bile, and black bile)

Agostino Bassi (1733 - 1856)
- Germ theory of disease
- Silkworm disease was due to a fungal infection

MJ Berkeley (1803 - 1889)
- Potato blight was caused by a protozoan (thought to be a fungus)

Heinrich de Bary (1831 - 1888)
- Fungi caused crop disease

Joesph Lister (1827 - 1912)
- Developed antiseptic surgery practices
- Sterilized instruments through heat and phenol

### Koch's Postulates

**Koch's postulates** - a set of rules of proving that a microorganisms causes a particular disease

- First demonstration that bacteria cause disease came from anthrax

![](Pasted%20image%2020250523173604.png)

Flaws of Koch's Postulates
- Viruses and organisms that must live within host cells cannot be isolated in pure culture
- Some human diseases lack an appropriate animal model
- Detect nucleic acid of a microorganisms in body tissues, rather than isolating it
- Genes of a virulence of a disease can mutate

Charles Chamberland (1851 - 1908)
- Porcelain filter to remove bacteria

Dimitri Ivanowaski (1864 - 1920) and Martinus Beijerinck
- Used the filter to study tobacco mosaic disease
- Discovers acellular infectious agents that were smaller than bacteria

### Immunology

Pasteur and Pierre Roux (1853 - 1933)
- Bacteria incubated in cultures for long periods lost their ability to cause disease (attenuated)
- Called the attenuated bacteria a vaccine
- Developed attenuated anthrax vaccine, rabies virus

Edward Jenner (1749 - 1823)
- User material from cowpox lesions to protect people against smallpox

- White blood cells and the chemical they produce play a central role in immunity
...
- Discovery that diphtheria was caused by toxin from bacteria
- The inactivated toxin produced an antitoxin/antibodies
- Role of antibodies in preventing disease

- Antibodies bind and neutralize toxins

Elie Metchnikoff (1845 - 1916)
- White blood cell engulf disease causing bacteria
...
- Soil microbiology
- Discovery that soil bacteria could oxidize iron, sulfur, and ammonia to obtain energy
- Bacteria would use CO_2 in organic matter similar to photosynthetic organisms
- Decomposition of cellulose from anaerobic nitrogen-fixing and sulfate-reducing bacteria

Beijerinck and Winogradsky
- Developed enrichment culture techniques and selective media

# 1.4 Microbiology Encompasses Many Subdisciplines

---

- Microbiology has basic and applied aspects that are intertwined
- Microbiology
	- Bacteriology
	- Virology

- Each sub-discipline can be further divided based on activities of microbes (environmental microbiology, agricultural microbiology)
- Medical microbiology deals with diseases of humans
- Track new, unidentified pathogens
...
- Microbial ecology describes the diversity of microbes in terms of morphology, physiology, and relationship with organisms and habitats
	- Carbon cycle
	- Nitrogen cycle
	- Sulfur cycle
- Bioremediation n the form of production and removal of GHG such as methane and carbon dioxide

- Agricultural microbiology is concerned with the impact of microorganisms on food production, such as nitrogen-fixing bacteria, which affect soil fertility
- Digestive microbes in cattle and animal digestive tracts
- Plant and animal pathogens
- Bacterial and viral insect pathogens as substitutes for chemical pesticides

- Food microbiology study the microbes used to make food and beverages, as well as food spoilage or pathogens

- Industrial microbiology involves the use of microbes to make products helpful to humans
- Produces vaccines, steroids, alcohols, and other solvents, vitamins, amino acids, enzymes, and biofeuls

Alexander Fleming (1929)
- Discovered that fungus _Penicilium sp._ produced penicillin, the first antibiotic that could control bacterial infections
