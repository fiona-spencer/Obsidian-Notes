...
- In Gram-negative bacteria, adheres non-covalently to the outer membrane

Advantages of S-Layer
- Use in nanotechnology
	- Protecting cell against ion and pH fluctuations, osmotic stress, enzymes, or predatory bacteria
	- Self-assemble, proteins contain information to spontaneously associate and form S-layer without additional factors
- Maintains the shape and envelope rigidity
- Promote adhesion to surfaces
- Protect bacterial pathogens against host defenses, contributing to their virulence

![](Pasted%20image%2020250525134412.png)
...
- The cytoplasm is further divided into the cytosol
	- Inclusions
	- Ribosomes
	- Plasmids
- Molecules dissolved in the cytosol

**Cytosol** - liquid component of the cytoplasm

- Macromolecules create _macromolecular crowding_
- Less space around each molecules
- Cytoplasm is about 10x more viscous than water
...
- Cytoskeleton polypeptides polymerize to form functional filaments
	- Cell division
	- Maintains cell shape
	- Positioning and segregating inclusions and plasma DNA
- Some bacterial and archaeal cytoskeleton proteins share common ancestors with actin and tubulin, components of eukaryotic cytoskeleton

![](Pasted%20image%2020250525144117.png)

Rod-shaped
- Cell wall is sculpted by actin homologue MreB and related proteins, whose filaments associate with the plasma membrane and position the enzymes that synthesize peptidoglycan as the cell grows

Curved-bacteria
- CreS protein localizes the inner surface of the curve
- CreS is a homologue of eukaryotic intermediate filaments

![](Pasted%20image%2020250525144412.png)

- Tubulin homologue FtsZ is a filament that forms a ring at the center of a dividing cell that constricts as the daughter cel separate
- The Z-ring is a structural platform for enzymes that synthesize the new cell wall

## Intracytoplasmic Membranes

- Internal membranes of photosynthetic cyanobacteria are called thylakoids and are analogous to that of chloroplasts

![](Pasted%20image%2020250525144633.png)

- Internal membranous structures may be aggregates of spherical vesicles, flattened vesicles, or tubular membranes
- Often connected to the plasma membrane and arise fro it by invagination
- Internal membranes are enriched in molecules involved in energy conservation
	- Thylakoids of cyanobacteria contain the chlorophyll and photosynthetic reaction centers for converting light energy into ATP
- Function of internal membranes is to provide a larger membrane surface for greater metabolic activity

## Inclusions

**Inclusions** - granules, crystals, or globules or organic or inorganic material in the cytosol of cells
- Formed by the aggregation of substances that are organic or inorganic
- Segregate cellular components, to avoid diffusion with cytoplasm
	- Storage sites
	- Locations to sequester enzymatic reactions
	- Guides for cell movement
- Clusters of viral proteins or virions within the nucleus or cytoplasm of virus-infected cells

- Storage inclusions are use when one nutrient is ready but another is not
	- Glycogen inclusions
	- Polyhydroyalkanoate (PHA) granules
	- Sulfur globules
	- Polyphosphate granules

- Carbon is often stored in PHA granules, called carbosomes
- PHA are surrounded by a single-layered protein shell
	- Used in biodegradable plastics


![](Pasted%20image%2020250525145317.png)

- Polyphosphate granules and sulfur globules are inorganic inclusions
- Store phosphate needed for nucleic acids
- Phosphate is used as energy when hydrolysized
- Some photosynthetic bacteria use hydrogen sulfide (rather than water) as an electron donor
- Some bacterial inclusions are micro-ocompartments are large polyhedra
	- Bounded by a protein shell


#### Organelles Without Membranes
- Cyanobacteria and other CO_2-fixing organisms segregate RuBisCo in carboxysomes


![](Pasted%20image%2020250525145827.png)

- RuBisCo is joined in the carboxysome by scaffold protein that assemble by LLPS
...
- RuBisCo and scaffold units have regions that are structurally disordered
	- Amino acids are not fixed in a typical protein configuration
	- Assemble the carboysome polyhedron

**Biomolecular condensate** - a protein complex separated from the cytoplasm by its biophysical properties, not by a membrane

- Separated by biophysical properties of the molecules at high concentration
...
- Present in CO_2-fixing bacteria
- ~100 nm

2 Enzymes Critical for CO_2 Fixation
- Carbonic anhydrase (CA)
- Ribulose 1,5-biphosphate carboxylase/oxygenase (RbBisCo)

- CA releases CO_2 into protein shell so that is accumulates to a high concentration
- RuBisCo catalyzes the conversion of CO_2 to sugar

2 Inclusions For Movement
- Gas vacuoles
- Magnetosomes


**Gas vacuole** - a gas-filled vacuole found in cyanobacteria and some other aquatic bacteria and archaea that provides floatation
- It is composed of proteinacenous gas vesicles

**Gas vesicle** - Hollow, cylindrical structures composed of a single small protein that assemble to form a rigid cylinder that is impermeable to water

**Magnetosomes** - magnetic greigite or magnetite particles in magnetotactic bacteria that allow the bacteria to orient themselves in magnetic fields

- Northern Hemisphere bacteria determine northward and downward direction, to swim to nutrient-rich sediments or locate the optimum depth in freshwater and marine habitats
- Southern Hemisphere orient southward and downward, with the same result
- Made from magnetite (Fe_3O_4) or greigite (Fe_3S_4)
- ~35 to 125 nm
- Enclosed within invagination of the plasma membrane
- Arranged in a chain

![](Pasted%20image%2020250525155845.png)

## Bacterial Ribosomes

**Ribosome** - the organelle where protein synthesis occurs; the message encoded in mRNA is translated here

- 10,000 to 20,000 are found in nearly all cell
- Cytoplasmic ribosomes synthesize proteins that remain in the cell
- Plasma membrane-associated ribosomes make proteins in the cell envelope or transported outside
- Made from proteins and several ribonucleic acid (RNA) molecules
- Called 70S and are constructed of a 50S and a 30S subunit
- The S stands for Svedberg unit
	- Sedimentation coefficient, a measure of sedimentation velocity in a centrifuge
	- Function of a particles molecular weight, volume, and shape
	- Heavier and compact particles have larger S number
...
- Bacterial ribosomes are composed of rRNA
- The small subunit contained 16S rRNA, large subunit consists of 23S and 5S rRNA
- 55 proteins make up the rest of the mass of the ribosome
	- 21 small
	- 34 large

![](Pasted%20image%2020250525160440.png)
...
![](Pasted%20image%2020250525160518.png)

- Chromosome of most bacteria are double-stranded DNA
- Few have a linear chromosome
- Many carry a single copy of their chromosome (monoploid), but others are polyploid, with more than 10 copies per cell
- DNA is measures in base pairs (bp)
- Bacterial chromosomes are 0.5 to 10 Mbp
	- Repesents 500 to 10,000 genes
- Bacterial chromosomes are longer than itself
- Macromolecular crowding and supercoling contribute to nucleoid organization
- Macrodomains of about 1 Mbp, partition chromosome interaction domains
...
- Nucleoid-associated proteins (NAPs), are abundant DNA binding proteins that cause chromosome to bend and fold
- Electrostatic interaction
- Positively charged amino acids that aligns with negative DNA backbone
- On a short segment of DNA, NAPs bend or stiffen the chromosome
- On global level, NAPs bridge non-adjacent regions of the chromosome
- Cell division

![](Pasted%20image%2020250525161052.png)
