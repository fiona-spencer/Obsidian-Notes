...
- Fixation inactivates enzymes that might disrupt cell morphology and toughens cell structures so that they do not change during staining

**Heat fixation** - The process in which a sample is passed through a flame to adhere and kill the microorganisms

- Use for bacteria and archaea
- Preserves morphology and inactivates enzymes
- Destroys protein and sub-cellular structures

**Chemical fixation** - chemicals (formaldehyde, ethanol, methanol) are used to preserve cellular structures and prevent degradation

- Protects fine cellular structures
- Used when examining microorganisms by electron microscopy techniques
- Inactivates proteins and lipids, to insoluble and immobile
- Common fixative mixtures
	- Ethanol
	- Acetic acid
	- Mercuric chloride
	- Formaldehyde
...
- Chemical moieties with conjugated double bonds
- Bind cells by ionic, covalent, or hydrophobic bonds

- Ionic interactions are divided into basic and acidic dyes

![](Pasted%20image%2020250523202531.png)

- DNA can be stained by the Feulgen procedure where the staining compound (Schiff's reagent) is covalently attached to the deoxyribose sugars of DNA
- Sudan III selectively stains lipids because it is lipid soluble but does not dissolve in aqueous portions of the cell
- Simple staining, where a single dye is used, results from a fixed smear that is covered with acidic or basic dye

![](Pasted%20image%2020250523202819.png)
...
![](Pasted%20image%2020250523202933.png)
...
- Used to identify _Mycobacterium tuberculosis_ and _M. leprae_
- These bacteria have cell walls containing lipids constructed from mycolic acids, a group of branched-chain hydroxy fatty acids, which prevents dyes from readily binding to the cells
- The cold Ziehl-Neelsen method, uses high concentrations of phenol and carbon fuchsin, and a wetting agent, to drive the stain into mycobacterial cells
- Cells that are not easily decolourized by acidified alcohol are acid-fast

![](Pasted%20image%2020250523203234.png)

- One of the simplest staining procedures is capsule staining, which reveals the presence of capsules, a network made of polysaccharides
- Cells are mixed with India ink or nigrosin, and the cell appear as bodies surrounded by a halo of capsule since the ink cannot penetrate the cell or capsule


**Flagellum** - a threadlike appendage on many cells that is responsible for motility
...
- Flagella staining provides taxonomically valuable information about the presence and distribution pattern of flagella on bacterial and archaeal cells
- Bacterial flagella thickness is increased by coating them with mordants such as tannic acid and potassium alum, and staining with basic fuchsin
...
- Bacteria and archaea can only be observed in 1 to 2 $\micro$m

![](Pasted%20image%2020250523203828.png)

- In electron microscopes, electrons replace light as the illuminating beam
- The wavelength of electrons is ~100,000 shorter than visible light
- Therefore, EM have a resolution 1000X better and a resolution of 0.2 nm

![](Pasted%20image%2020250523204022.png)
...
- Uses a heated tungsten filament in the electron gun to generate a beam
- Doughnut-shaped electromagnets called magnetic lenses focus the beam
- Lenses must be under vacuum, since electrons are deflected by air molecules
- The passing electrons form an image on fluorescent screen that interfaces with a computer
- Denser regions scatter more electron and appear darker

![](Pasted%20image%2020250523204237.png)

- The TEM has many restrictions
	- Specimens must be viewed in a vacuum
	- Specimens must be extremely thin (20 to 100 nm)
	- Specimens are fixed with glutaraldehyde and osmium tetroxide to stabilize cell structure

![](Pasted%20image%2020250523204437.png)

- The probability of electron scattering is determined by the density (AN) of atoms in the specimen
- TEM include negative staining and shadowing
- Specimen is spread out in a thin film and appear bright against a dark background
- Enables visualization of viruses and cellular microbes, although internal structures cannot be discerned
- Shadowing, resulted when a specimen is coated with a thin film of platinum or other heavy metal by evaporation
- The are area coated with metal appears dark, whereas the shadow region is light
	- Used for virus particle morphology, bacterial and archaeal flagella, and DNA


![](Pasted%20image%2020250523204908.png)

- Chemical fixation and dehydration can introduce artifacts
- This is minimized using freeze-etching
- Cells are rapidly frozen in liquid nitrogen, and become brittle and broken down the middle of internal membranes
- The surface is coated with layers of platinum and carbon to form a replica of the surface

![](Pasted%20image%2020250523205050.png)

- Viruses can be visualized only through the use of EM
...
- Produces an image from electrons released form an object's surface
- Most SEMs have a resolution of about 10 nm
- Microorganisms must be fixed, dehydrated, and dried to preserve surface structure
- SEM scans a narrow electron beam over the specimen
- The discharge of electrons are trapped by a detector and produced a digital image

![](Pasted%20image%2020250523205348.png)

- Raise areas appear lighter on the screen and depressions are darker
- Used for realistic imaging of microorganism's surface results

![](Pasted%20image%2020250523205445.png)
...
- Protein crystallization and X-ray diffraction has long been used of resolving protein structure, not all proteins can be crystallized
- Richard Henderson invented the approach to see proteins using TEM
- James Dubochet rapidly froze samples so water could not form crystalline ice, which caused vitrified molecules to retain their 3D shape
- Joachaim Fram built an imaging system to create high-resolution photo-micrographs
- Enabled the visualization of individual atoms in stable proteins

![](Pasted%20image%2020250523205833.png)
...
- Atomic force and scanning tunnelling microscope

- Measure the surface features of an object by moving a sharp probe

**Scanning tunnelling microscope** - A microscope used to study surface features by moving a sharp probe over the object's surface

- Achieve magnification of 100 million times
- View atoms on the surface of a solid
- A voltage and electron cloud produces a image of the surface atoms
- Microscope can examine objects in water
- Invented by Gerd Binning and Heinrich Rohrer in 1986

![](Pasted%20image%2020250523210234.png)

**Atomic force microscope** - a microscope used to study surface features by moving a sharp probe over the object's surface
- Another type of SPM

- The vertical motion of the tip is followed by measuring the deflection of a laser beam that strikes the lever holding the probe
- The microscope can be used to study surfaces that do not conduct electricity well
- Used on interactions of proteins, living bacteria and other cells, and to visualize membrane proteins (aquaporins)
![](Pasted%20image%2020250523210520.png)

![](Pasted%20image%2020250523210539.png)